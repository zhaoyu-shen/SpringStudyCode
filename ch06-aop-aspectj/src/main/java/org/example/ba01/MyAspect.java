...
//    public void myBefore(){
//        //切面要执行的功能代码
//        System.out.println("4======前置通知，切面功能：在目标方法之前输出执行时间："
//                +new Date());
//    }
...
//        //切面要执行的功能代码
//        System.out.println("5======前置通知，切面功能：在目标方法之前输出执行时间："
//                +new Date());
//    }
    ...
    *   作用是：可以在通知方法中获取目标方法执行时的信息，例如：方法名称，方法实参。
    *   如果你的切面功能中需要用到方法的信息，就加入JoinPoint
    *   这个JoinPoint参数是由框架赋予，必须是第一个位置的参数
    * */
    @Before(value = "execution(void *..SomeServiceImpl.doSome(String,Integer))")
